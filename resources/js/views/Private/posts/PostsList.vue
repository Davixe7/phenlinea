<template>
  <div id="posts-list">
    <span class="form-section-title">Todos los posts</span>
    <div v-if="posts && posts.length" class="posts-list">
      <div class="default-content" v-for="post in posts">
        ...
        <div v-if="post.pictures && post.pictures.length" class="pictures-list">
          <div
            v-for="(picture, _index) in post.pictures"
            class="picture-wrapper"
            @click="pictures=post.pictures; index=_index">
            <img :src="picture.url">
          </div>
        </div>
