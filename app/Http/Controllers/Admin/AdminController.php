...
class AdminController extends Controller
{
  ...
  public function update(Request $request, Admin $admin)
  {
    ...
    $admin->update([
      ...
      'device_building_id'     => ($request->device_building_id)     ?: $admin->device_building_id,
      'device_serial_number'   => ($request->device_serial_number)   ?: $admin->device_serial_number,
      'device_2_serial_number' => ($request->device_2_serial_number) ?: $admin->device_2_serial_number,
