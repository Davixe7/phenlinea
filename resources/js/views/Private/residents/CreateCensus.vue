  ...
  <div id="create-census">
    <form ref="storeCensusForm" id="create-census-form" @submit.prevent="">
      <div class="row d-flex align-items-center mb-4">
        ...
        <div v-if="extension && extension.id"
      ...
      <div class="row" style="margin-bottom: 50px;">
            ...
            <div class="form-section">
              ...
              <div class="form-group row">
                <label class="col-7" title="requerido">
                  <i class="material-icons">meeting_room</i> Número Apto. <span class="text-red">*</span>
                </label>
                <div class="col-5">
                  <input type="tel" class="form-control" :class="{'is-invalid':errors.name}" v-model="extName" placeholder="número de apartamento" required>
                  <div v-if="errors.name" class="invalid-feedback">{{ errors.name[0] }}</div>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-7" title="requerido">
                  <i class="material-icons">account_circle</i> Nombre propietario
                </label>
                <div class="col-5">
              ...
              <div class="form-group row">
                <label class="col-7" title="requerido">
                  <i class="material-icons">phone</i> Teléfono propietario
                </label>
                <div class="col-5">
                  <input type="tel" class="form-control" :class="{'is-invalid':errors.owner_phone}" maxlength="10" minlength="10" v-model="ownerPhone">
              ...
              <div class="form-group row">
                <label class="col-7">
                  <i class="material-icons">alternate_email</i> Email
                </label>
                <div class="col-5">
              ...
              <div class="form-group row">
                <label class="col-7">
                  <i class="material-icons">pets</i> Número de Mascotas
                </label>
                <div class="col-5">
              ...
              <div class="form-group row">
                <label class="col-7">
                  <i class="material-icons">format_paint</i> Parqueadero
                </label>
                <div class="col-5 form-check form-check-inline mr-0">
                  <label for="has_own_parking_true" class="form-check-label mr-2">
                    <input 
                      type="radio"
                      v-model="has_own_parking"
                      :value="1"
              ...
              <div class="form-group row">
                ...
                <div class="col-5 form-check form-check-inline mr-0">
                  <label for="radio1" class="form-check-label mr-2">
                      <input class="form-check-input" type="radio" id="radio1" v-model="hasDeposit" :value="1"/>
                      Sí
                  </label>
                  <label for="radio2" class="form-check-label">
                      <input class="form-check-input" type="radio" id="radio2" v-model="hasDeposit" :value="0"/>
                      No
                  </label>
                </div>
              </div>
              ...
              <div class="row my-3">
                <div class="form-group col-6">
                  <input type="text" class="form-control" :class="{'is-invalid':errors.emergency_contact_name}" placeholder="Nombre" v-model="emergency_contact_name">
                  <div v-if="errors.emergency_contact_name" class="invalid-feedback">{{ errors.emergency_contact_name[0] }}</div>
                </div>
                <div class="form-group col-6">
                  <input
                    type="tel"
          ...
          <div class="col-md-4 mb-3">
            <div class="form-section">
              ...
              <div class="d-flex mb-3">
                <input type="text" class="form-control" placeholder="Placa" v-model="newVehicle.plate" style="max-width: 150px;">
          ...
          <div class="col-md-4 mb-3">
            <div class="form-section color-card mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" :class="{'is-invalid':errors.phone_3}" maxlength="10" minlength="10" v-model="phone_3">
                    <div v-if="errors.phone_3" class="invalid-feedback">{{ errors.phone_3[0] }}</div>
                </div>
                <div class="form-group">
                    <label for="line1">Línea 4</label>
                    <input type="tel" class="form-control" :class="{'is-invalid':errors.phone_4}" maxlength="15" minlength="3" v-model="phone_4">
        ...
        <CensusResident v-else :_residents="residents" :extensionId="extensionId"/>
    </form>
  </div>
</template>
    
<script>
  import CensusResident from './CensusResident.vue'
  export default {
    components: { CensusResident },
    name: 'CreateCensus',
    props: ['extensionId'],
    data(){
      return {
