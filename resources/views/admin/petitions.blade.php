...
<script>
    ...
    setup () {
        ...
        const filters = Vue.ref([
            {value:'read_at', label: 'No leídos'},
            {value:'replied_at', label: 'Sin responder'},
            {value:'all', label: 'Todos'},
        ])
        
        const filter = Vue.ref({value:'all', label: 'Todos'})
        ...
        function markAsRead(pqrs){
            ...
            axios.post('https://phenlinea.com/pqrs/' + currentPqrs.value.id + '/markAsRead', {_method: 'PUT'})
            .then(response => {
        ...
        return {
            ...
            reply,
            columns: [
                { align: 'left', name: 'id',   label: 'Código',    field: 'id', sortable: true },
                { align: 'left', name: 'created_at',   label: 'Creado',    field: 'created_at', sortable: true },
                { align: 'left', name: 'read_at',   label: 'Leído',    field: 'read_at', sortable: true },
                { align: 'left', name: 'replied_at',   label: 'Respuesta enviada', field: 'replied_at', sortable: true },
                { align: 'left', name: 'name',   label: 'Nombres', field: 'name', sortable: true },
                { align: 'left', name: 'phone',  label: 'Teléfono', field: 'phone', sortable: true },
                { align: 'right', name: 'action',  label: 'Acciones'},
            ],
        }
    },
  })
