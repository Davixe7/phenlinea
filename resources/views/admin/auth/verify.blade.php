        ...
        <div class="card-body">
          ...
          <form action="{{ route('verifyphone') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 30px;">
              ...
              <input minlength="6" maxlength="6" max="6" type="text" id="verification_code" class="form-control @error('naverification_codeme') is-invalid @enderror" name="verification_code" required />
            ...
            <div class="form-group d-flex">
              <v-btn type="button" class="mr-3" style="flex: 1 0 auto;">
                Reenviar Código
              </v-btn>
              <v-btn type="submit" dark style="flex: 1 0 auto;">
                Confirmar
              </v-btn>
            </div>
          </form>
