...
Route::middleware('auth:admin')->get('whatsapp/logout', 'WhatsappController@logout')->name('whatsapp.logout');
Route::middleware('auth:admin')->post('whatsapp/send', 'WhatsappController@sendMessage')->name('whatsapp.send');
